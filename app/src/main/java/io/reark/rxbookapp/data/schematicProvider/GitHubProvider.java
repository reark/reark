...
public class GitHubProvider {
    public static final String AUTHORITY = "io.reark.rxbookapp.data.schematicProvider.GitHubProvider";
    ...
    @TableEndpoint(table = GitHubDatabase.GITHUB_REPOSITORIES) public static class GitHubRepositories {
        @ContentUri(
                ...
                type = "vnd.android.cursor.dir/vnd.io.reark.rxbookapp.repository",
        ...
        @InexactContentUri(
                ...
                type = "vnd.android.cursor.item/vnd.io.reark.rxbookapp.repository",
    ...
    @TableEndpoint(table = GitHubDatabase.GITHUB_REPOSITORY_SEARCHES) public static class GitHubRepositorySearches {
        @ContentUri(
                ...
                type = "vnd.android.cursor.dir/vnd.io.reark.rxbookapp.repositorysearch",
        ...
        @InexactContentUri(
                ...
                type = "vnd.android.cursor.item/vnd.io.reark.rxbookapp.repositorysearch",
    ...
    @TableEndpoint(table = GitHubDatabase.USER_SETTINGS) public static class UserSettings {
        @ContentUri(
                ...
                type = "vnd.android.cursor.dir/vnd.io.reark.rxbookapp.usersettings",
                defaultSort = JsonIdColumns.ID + " ASC")
        ...
        @InexactContentUri(
                ...
                type = "vnd.android.cursor.item/vnd.io.reark.rxbookapp.usersettings",
    ...
    @TableEndpoint(table = GitHubDatabase.NETWORK_REQUEST_STATUSES) public static class NetworkRequestStatuses {
        @ContentUri(
                ...
                type = "vnd.android.cursor.dir/vnd.io.reark.rxbookapp.networkrequeststatus",
                defaultSort = JsonIdColumns.ID + " ASC")
        ...
        @InexactContentUri(
                ...
                type = "vnd.android.cursor.item/vnd.io.reark.rxbookapp.networkrequeststatus",
